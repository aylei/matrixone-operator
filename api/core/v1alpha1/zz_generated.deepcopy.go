...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DNStore) DeepCopyInto(out *DNStore) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DNStore.
func (in *DNStore) DeepCopy() *DNStore {
	if in == nil {
		return nil
	}
	out := new(DNStore)
