...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MatrixOneCommonSpec) DeepCopyInto(out *MatrixOneCommonSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MatrixOneCommonSpec.
func (in *MatrixOneCommonSpec) DeepCopy() *MatrixOneCommonSpec {
	if in == nil {
		return nil
	}
	out := new(MatrixOneCommonSpec)
	in.DeepCopyInto(out)
	return out
}
